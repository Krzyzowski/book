...
cheeses = ['topiony', 'żółty', 'pleśniowy']
for cheese in cheeses:
    if cheese.startswith('a'):
        print("Nie jem niczego, co się zaczyna na 'a'")
        break
    else:
        print(cheese)
else:
    print("Nie ma niczego, co zaczynałoby się na 'a'")
...
cheeses = []
for cheese in cheeses:
    print('W tym sklepie jest smakowity ser', cheese)
    break
else: # Niewykonanie instrukcji break oznacza, że nie ma sera
    print('W tym sklepie nie ma zbyt wielu serów, prawda?')

print( ) #dodamy element
...
# Pętla iteruje po krotkach zawierających po jednym elemencie z każdej listy
for day, fruit, drink, dessert in zip(days, fruits, drinks, desserts):
    # Poprawna składnia funkcji print z odpowiednimi spacjami
    print(day, ": do picia -", drink, ", do jedzenia -", fruit, ", na deser -", dessert)