...
# g
#WALRUS???
#abs = wartośc absoutna??

tweet_limit = 280
tweet_string = "coś" * 1050
...
# h tu coś nie tak ze zliczaniem diff, daje True lub False
tweet_limit = 280
tweet_string = "coś" * 50 
if diff := tweet_limit - len(tweet_string) >= 0: # do poczytania
    print("Example h. Dobry tweet")
    print(diff)
else:
    print(" Example h. Tweet za długi o", abs(diff), "znaków")
    print('Example g tweet_limit = ' , diff) #coś nie tak
print(                )
